<script lang="ts">
  ...
  const groups = [
    ...
    { name: "Wikipedia", colors: [
      { name: "Republican 1", margins: [
        "#a80000", "#c21b18", "#d72f30", "#d75d5d",
        "#e27f7f", "#ffb2b2", "#ffc8cd", "#ffe0ea"
      ]},
      { name: "Republican 2", margins: [
        "#800000", "#aa0000", "#d40000",
        "#cc2f4a", "#e27f90", "#f2b3be", "#ffccd0"
      ]},
      { name: "Democrat 1", margins: [
        "#0d0596", "#3933e5", "#584cde", "#6674de",
        "#7996e2", "#a5b0ff", "#bdd3ff", "#dfeeff"
      ]},
      { name: "Democrat 2", margins: [
        "#002b84", "#234a99", "#466aad",
        "#6a89c2", "#8da8d6", "#b0c8eb", "#d3e7ff"
      ]}
    ]}
  ];
  ...
  <div class="modal-box">
    ...
    <div class="tabs">
      {#each groups as group, index}
        <button class="tab tab-bordered tab-lg"
